                ...
                <div>
                  <div className="intro-content--mentee">
                    <h1 className="sc-eqUAAy bYPSFE mb-3">
                      Learn and grow with help from world-className mentors for free
                    </h1>
                    <h4
                ...
                <div>
                  <div className="intro-content--mentor">
                    ...
                    <h4 className="sc-iGgWBj inuyVc font-weight-400">
                      Build confidence as a leader, grow your network, and
                      define your legacy.
                    </h4>
                  </div>
                  <button
